...
public class Constant {
    //内网接口
    public static final String WEB_SITE = "https://pub-66934c5b98e747aa88ccdc132e1aeb17.r2.dev/topline/topline";
    //首页广告接口
    public static final String REQUEST_AD_URL = "/home_ad_list_data.json";
    //首页新闻列表接口
    public static final String REQUEST_NEWS_URL = "/home_ad_list_data.json";
    //python新闻列表接口
